...
export const PRODUCTS_DATA: ProductCard[] = [
  ...
  // 5. JOBOBIKE Romer Pro
  {
    ...
    tekniskeSpesifikasjoner: {
      ...
      giring: { type: "Ekstern gir", gir: "8-trinns Shimano", girskifter: "Shimano vrigrep" },
      elektrisk: {
    ...
    keyFeatures: [
      "250W Bafang Hub, 80Nm",
      "36V 14Ah (504Wh)",
      "Opptil 160km i øko-modus",
      "27.5\" dekk for stabilitet",
      "Dobbel ramme (maks last 150kg)",
      "Gjennomgående ramme",
      "Hydrauliske skivebremser",
      "Shimano 8-trinns",
  ...
  // 6. JOBOBIKE Ace Pro
  {
    ...
    tekniskeSpesifikasjoner: {
      ...
      bremser: { foran: "Tektro hydraulisk skive", bak: "Tektro hydraulisk skive", type: "Hydraulisk" },
  ...
  // 9. JOBOBIKE Lyon Pro
  {
    ...
    specifications: {
      ...
      wheelSize: '27.5"',
      foldable: false,
      brakes: "Tektro Hydraulisk Skive",
      frame: "Aluminiumslegering",
      drivetrain: "Shimano 9-trinns",
    },
    tekniskeSpesifikasjoner: {
