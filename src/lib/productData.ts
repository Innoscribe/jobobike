...
export const PRODUCTS_DATA: ProductCard[] = [
  ...
  // 2. JOBOBIKE Luxe Sølvgrå
  {
    id: "luxe-grey-001",
    name: "LUXE Sølvgrå - JoboBike",
    slug: "jobobike-luxe-solvgra",
    originalPrice: 35011.32,
    price: 35011.32,
    discount: "9%",
    image: "/images/luxe/luxegrey1.jpg",
    images: ["/images/luxe/luxegrey1.jpg", "/images/luxe/luxegrey2.jpg"],
    features: [
      "Karbon drivrem system",
      "Intern 8-trinns giring",
      "Hydrauliske bremser",
  ...
  // 3. JOBOBIKE Robin
  {
    ...
    images: ["/images/robin/robin-1.png", "/images/robin/robin-2.png"],
    features: [
  ...
  // 4. JOBOBIKE Romer
  {
    ...
    badge: "Nytte",
    category: ["Sammenleggbar", "Fatbike", "Pendler", "Terreng"],
    rating: 4.6,
    reviewCount: 112,
    specifications: {
      motor: "250W nav, 80Nm",
  ...
  // 5. JOBOBIKE Romer Pro
  {
    ...
    keyFeatures: [
      ...
      "Hydrauliske skiver + dreiemomentsensor",
    ],
    availableSizes: ["One Size"],
    whatsInTheBox: [
  ...
  {
    id: "transer-001",
    name: "TRANSER Grønn - JoboBike",
    slug: "jobobike-transer-gronn",
    originalPrice: 37917.26,
    price: 37917.26,
    discount: "14%",
    image: "/images/transer/transer-1.png",
    images: ["/images/transer/transer-1.png", "/images/transer/transer-2.png", "/images/transer/transerwhite-1.jpg", "/images/transer/transerwhite-2.jpg", "/images/transer/transergrey-1.jpg", "/images/transer/transergrey-2.jpg"],
  ...
  // 11b. JOBOBIKE Transer Hvit
  {
    id: "transer-white-001",
    name: "TRANSER Hvit - JoboBike",
    slug: "jobobike-transer-hvit",
    originalPrice: 37917.26,
    price: 37917.26,
    discount: "14%",
    image: "/images/transer/transerwhite-1.jpg",
    images: ["/images/transer/transerwhite-1.jpg", "/images/transer/transerwhite-2.jpg"],
    features: ["250W midtmotor", "48V 17,5Ah batteri", "Lastekasse inkludert", "Familievennlig", "Lang ramme"],
    badge: "Familievalg",
    category: ["Lastesykkel", "Pendler"],
    rating: 4.8,
  ...
  // 11c. JOBOBIKE Transer Grå
  {
    id: "transer-grey-001",
    name: "TRANSER Grå - JoboBike",
    slug: "jobobike-transer-gra",
    originalPrice: 37917.26,
    price: 37917.26,
    discount: "14%",
    image: "/images/transer/transergrey-1.jpg",
    images: ["/images/transer/transergrey-1.jpg", "/images/transer/transergrey-2.jpg"],
    features: ["250W midtmotor", "48V 17,5Ah batteri", "Lastekasse inkludert", "Familievennlig", "Lang ramme"],
    badge: "Familievalg",
    category: ["Lastesykkel", "Pendler"],
    rating: 4.8,
  ...
  // 20. JOBOBIKE Dyno (ST)
  {
    ...
    keyFeatures: [
      "Gjennomgående ramme design",
      "26\" hybrid hjul",
      "250W baknav (40Nm)",
      "36V 13Ah batteri (468Wh)",
      "Mekaniske skivebremser",
      "Opptil 70km rekkevidde",
      "Shimano 7-trinns",
      "LED-display + frontdemping",
    ],
