    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            This information helps us improve our Site, understand user preferences, and provide a better user experience.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            Our Site uses cookies and similar tracking technologies to improve your browsing experience, analyze site traffic, and personalize content. You can control cookie settings through your browser, but please note that disabling cookies may affect the functionality of our Site.
          </p>
        </section>
